...
/**
  ...
  * @retval None
  */
void RCC_APB2PeriphClockCmd(uint32_t RCC_APB2Periph, FunctionalState NewState)//时钟使能
{
  /* Check the parameters */
  assert_param(IS_RCC_APB2_PERIPH(RCC_APB2Periph));//使能的外设名称
  assert_param(IS_FUNCTIONAL_STATE(NewState));//不使能DISABLE或使能ENABLE
  if (NewState != DISABLE)
  {
