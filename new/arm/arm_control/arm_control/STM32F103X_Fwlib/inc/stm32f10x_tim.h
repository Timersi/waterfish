...
//模式
 ...
 // 时钟分割                           This parameter can be a value of @ref TIM_Clock_Division_CKD */
...
/** @defgroup TIM_Output_Compare_and_PWM_modes //模式
  * @{
  */
...
/** @defgroup TIM_Output_Compare_Polarity //输出极性
  * @{
  */
...
/** @defgroup TIM_Output_Compare_state //使能通道
  * @{
  */
...
void TIM_TimeBaseInit(TIM_TypeDef* TIMx, TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct);//定时器初始化函数
void TIM_OC1Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct);
void TIM_OC2Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct);//定时器通道2初始化
...
void TIM_OC2PreloadConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCPreload);//使能定时器在通道2上的预装载寄存器
...
void TIM_SetCompare2(TIM_TypeDef* TIMx, uint16_t Compare2);//占空比调节函数
