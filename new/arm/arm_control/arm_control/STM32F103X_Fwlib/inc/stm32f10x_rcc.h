...
#define RCC_APB2Periph_AFIO              ((uint32_t)0x00000001)//端口重映射时钟
...
void RCC_APB2PeriphClockCmd(uint32_t RCC_APB2Periph, FunctionalState NewState);//APB1时钟使能
void RCC_APB1PeriphClockCmd(uint32_t RCC_APB1Periph, FunctionalState NewState);//APB2时钟使能
